...
function ComparisonPanel() {
  ...
  return (
    ...
    >
      ...
      <div className="type-body-02" style={{ color: "var(--text-secondary)", textAlign: "right", paddingRight: "var(--spacing-05)", paddingTop: "var(--spacing-03)", paddingBottom: "var(--spacing-03)" }}>
...
/*
 * Z2SensSubRow, Z2BlockDivider and LegacyZone2 are kept for historical
 * reference but are no longer used by the active Zone 2 implementation.
 */
function Z2SensSubRow() {
  return null;
}
  ...
  return (
    <div style={{ backgroundColor: "var(--bg-layer-02)" }}>
      ...
      >
        ...
        {/* Legacy content removed in favor of new Assumptions & Sensitivity tab */}
      </div>
...
/* ========================================================================
   ZONE 2 — Assumptions & Sensitivity (new implementation)
   ======================================================================== */
...
function SensitivityTable({
  ...
  const columnBg = (col: SensitivityColumn) =>
    col.isScenario ? "var(--bg-brand-subtle)" : "var(--bg-layer-01)";
  ...
  return (
    ...
    >
      {/* Header band — full-width row like Zone 1 */}
      <div
        style={{
          gridColumn: "1 / -1",
          marginLeft: `calc(-1 * ${H_PAD})`,
...
function Zone2() {
  ...
  return (
    <div style={{ backgroundColor: "var(--bg)" }}>
      ...
      <div style={{ height: "var(--spacing-06)" }} />
